...
<html lang="fr">
	<head>
    	...
    	<title>Supprimer l'étude <?php echo $ref; ?></title>
    ...
    $requete = "DELETE FROM etude WHERE reference='$ref'";
	...
	<div class="jumbotron">
      <div class="container">
        <h1 class="page-header">Etude Supprimée <small><?php echo $ref; ?></small></h1>
        <p><a class="btn btn-primary btn-lg" href="#" role="button" onclick="document.location.href='page_accueil.php'">Retour à l'accueil</a></p>
      </div>
      </div>
