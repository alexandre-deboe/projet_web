...
<div class="col-md-6 col-md-offset-3">
    <table class="table table-hover">
        ...
        $ou=$_GET['debut'];
        $requete="select reference,entreprise,date_debut from etude,client where etude.id_client=client.id and tag='En cours' order by date_debut DESC LIMIT $nb_affichage_par_page OFFSET $ou";
